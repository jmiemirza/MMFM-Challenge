...
params_enum['debug_port'] = ['docvl'] + [x for x in range(1)] #sandstone_flan_generic_basewatson_v2 # 'google/flan-t5-base' 'google/flan-t5-large' 'google/flan-t5-xl'
...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/.cache/huggingface/transformers_cache; source scripts/finetune_vicuna13b_clm.sh'
