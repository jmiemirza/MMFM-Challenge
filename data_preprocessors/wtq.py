        ...
        for i, split in enumerate(self.split):
            ...
            for j, d in enumerate(tqdm(data)):
                ...
                for k, ann in enumerate(d['annotations']):
                    ...
                    if f'wtq_{i}_{j}_{k}' in ids_list and split == 'dev':
                        continue
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_data_dir', default='raw_datasets/wtq/aws_neurips_time/WikiTableQuestions', type=str)
    parser.add_argument('--main_data_dir', default='.', type=str)
    parser.add_argument('--out_data_dir', default='processed_data/wtq', type=str)
    parser.add_argument('--img_data_dir', default='raw_datasets/wtq/jpgs/', type=str)
