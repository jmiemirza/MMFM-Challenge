...
class InstructData:
    ...
    def create_data(self):
        ...
        with open(os.path.join('data_preprocessors', 'ai2d_test_ids.csv')) as f:
        ...
        for i, file in enumerate(tqdm(sorted(os.listdir(self.question_dir)))):
            ...
            for j, (question, item) in enumerate(data['questions'].items()):
        ...
        for split, results in [('train', train), ('val', test)]:
