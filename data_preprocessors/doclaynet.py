...
class InstructData:
    ...
    def create_ocr_data(self, data):
        ...
        for i, image_info in enumerate(data['images']):
            ...
            ocr_info[image_id] = {'image_path': image_path
                , 'text_sequence': text_sequence, 'bboxes': bboxes, 'width': width, 'height': height
                                  }
        return ocr_info
    ...
    def create_data(self):
        ...
        for split in self.split:
            ...
            for i, image_id in enumerate(tqdm(annotations)):
