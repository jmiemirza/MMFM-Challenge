        ...
        for i, split in enumerate(self.split):
            ...
            for j, d in enumerate(tqdm(data)):
                ...
                for k, ann in enumerate(d['annotations']):
                    ...
                    if f'tabfact_{i}_{j}_{k}' in ids_list and split == 'dev':
                        continue

                    target_format.append({
                        'id': f'tabfact_{i}_{j}_{k}',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_data_dir', default='raw_datasets/tabfact/aws_neurips_time/TabFact', type=str)
    ...
    parser.add_argument('--img_data_dir', default='raw_datasets/tabfact/jpgs/', type=str)
